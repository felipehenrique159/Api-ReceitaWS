...
<div class="container">
    ...
    <div class="row my-5">
            ...
            <table class="table table-hover">
                ...
                <tr v-for="(cnpjs,key) in cnpjs" :key="key">
                     ...
                     <td><button @click="edit(cnpjs)" class="btn btn-primary">Editar</button></td>
                     <td><button @click="destroy(cnpjs)" class="btn btn-danger">Excluir</button></td>
                </tr>
            </table>
            </div>
            ...
            <div class="col-md-2">
                ...
                <input type="text" v-model="cnpj.nome" placeholder="Empresa" class="form-control"  required>
              <br>   <input type="text" v-model="cnpj.cnpj" placeholder="Digite um CNPJ" class="form-control" required>
    ...
    <div class="row">
        <div class="col-md-6">
            <input type="text" placeholder="CNPJ" v-model="cnpj.cnpj_cadastral" class="form-control"> <br>
...
import cnpjs from '../services/cnpj';
 ...
 export default {
     ...
     save(){   //salva e edita caso ja seja um registro existente
     ...
     edit(cnpj){  //setar campos com os valores para editar
         this.cnpj = cnpj;
     },
